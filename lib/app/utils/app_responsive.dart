...
class AppResponsive {
  ...
  static double getResponsiveSize(double size) {
    ...
    if (isDesktop) {
      screenSize = screenSize * 0.5; // Reduce size for desktop
    } else if (isTablet) {
      screenSize = screenSize * 0.75; // Reduce size for tablet
    }
    return (size / 375) * screenSize; // 375 is base width for mobile design
  }
