...
class AppText {
  ...
  static TextStyle h5({Color? color}) => GoogleFonts.montserrat(
       ...
       static TextStyle h5thin({Color? color}) => GoogleFonts.montserrat(
        fontSize: 20,
        letterSpacing: 0,
  ...
  // Paragraph Styles
  static TextStyle p({Color? color}) => GoogleFonts.montserrat(
        fontSize: 16,
        letterSpacing: 0,
        height: 1.5,
        fontWeight: FontWeight.w400,
  ...
  static TextStyle pLead({Color? color}) => GoogleFonts.montserrat(
        fontSize: 20,
        letterSpacing: 0,
        height: 1.5,
  ...
  static TextStyle pSmall({Color? color}) => GoogleFonts.montserrat(
        fontSize: 14,
        letterSpacing: 0,
        height: 1.5,
        fontWeight: FontWeight.w400,
  ...
  static TextStyle pSmallBold({Color? color}) => GoogleFonts.montserrat(
        fontSize: 14,
        letterSpacing: 0,
        height: 1.5,
        fontWeight: FontWeight.w600,
  ...
  // Small Text Style
  static TextStyle small({Color? color}) => GoogleFonts.montserrat(
        fontSize: 12,
        letterSpacing: 0,
        height: 1.2,
        fontWeight: FontWeight.w400,
  ...
  static TextStyle smallBold({Color? color}) => GoogleFonts.montserrat(
        fontSize: 12,
        letterSpacing: 0,
        height: 1.2,
        fontWeight: FontWeight.w600,
  ...
  // Overline Style
  static TextStyle overline({Color? color}) => GoogleFonts.montserrat(
        fontSize: 10,
        letterSpacing: 1.5,
        fontWeight: FontWeight.w400,
        color: color,
